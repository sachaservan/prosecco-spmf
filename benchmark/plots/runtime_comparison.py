...
def compute(dataset, fsize, name, showDivider):
    ...
    lookup = {'BMS' : 'BMS-WebView1', 'KORSARAK' : 'Kosarak', 'FIFA' : 'FIFA', 'BIBLE' : 'Bible', 'SIGN' : 'Sign', 'ACCIDENTS' : 'Accidents', 'MSNBC' : 'MSNBC'}
...
datasets = ['ACCIDENTS-0.80', 'ACCIDENTS-0.85', 'ACCIDENTS-0.90',
            ...
            'BMS-0.01', 'BMS-0.025', 'BMS-0.05', 
            'FIFA-0.30', 'FIFA-0.35', 'FIFA-0.40', 
            'KORSARAK-0.025', 'KORSARAK-0.05', 'KORSARAK-0.10',
            'MSNBC-0.20', 'MSNBC-0.30', 'MSNBC-0.40']
compute(datasets, (12, 3.0), 'runtime', True)

datasets = ['ACCIDENTS-0.80', 'ACCIDENTS-0.85', 'ACCIDENTS-0.90']
compute(datasets, (5, 3.5), 'runtime_accidents', False)

datasets = ['BMS-0.01', 'BMS-0.025', 'BMS-0.05']
compute(datasets, (5, 3.5), 'runtime_bms', False)

datasets = ['FIFA-0.30', 'FIFA-0.35', 'FIFA-0.40']
compute(datasets, (5, 3.5), 'runtime_fifa', False)

datasets = ['KORSARAK-0.025', 'KORSARAK-0.05', 'KORSARAK-0.10']
compute(datasets, (5, 3.5), 'runtime_kosarak', False)

datasets = ['BIBLE-0.40', 'BIBLE-0.50', 'BIBLE-0.60']
compute(datasets, (5, 3.5), 'runtime_bible', False)

datasets = ['MSNBC-0.20', 'MSNBC-0.30', 'MSNBC-0.40']
compute(datasets, (5, 3.5), 'runtime_msnbc', False)