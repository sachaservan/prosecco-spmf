...
# java -jar -Xmx40G ProseccoBenchmark.jar -f "/home/ez/data/sequence/bms-webview.txt" -s 0.01 -z 20000 -d 17880001 -r "/usr/local/bin/shuf" -i "n_ps-bms-webview-lg-0.01-20k" -o "./results/n_ps-bms-webview-lg-0.01-20k_results_runtime_correctness.json" -n 5 --benchmarkRuntime --prosecco
# java -jar -Xmx40G ProseccoBenchmark.jar -f "/home/ez/data/sequence/bms-webview.txt" -s 0.01 -z 40000 -d 17880001 -r "/usr/local/bin/shuf" -i "n_ps-bms-webview-lg-0.01-40k" -o "./results/n_ps-bms-webview-lg-0.01-40k_results_runtime_correctness.json" -n 5 --benchmarkRuntime --prosecco
# java -jar -Xmx40G ProseccoBenchmark.jar -f "/home/ez/data/sequence/bms-webview.txt" -s 0.01 -z 80000 -d 17880001 -r "/usr/local/bin/shuf" -i "n_ps-bms-webview-lg-0.01-80k" -o "./results/n_ps-bms-webview-lg-0.01-80k_results_runtime_correctness.json" -n 5 --benchmarkRuntime --prosecco
