...
java -jar -Xmx40G ProseccoBenchmark.jar -f "/home/ez/data/sequence/bms-webview.txt" -s 0.1 -z 10000 -d 17880001 -r "/usr/local/bin/shuf" -i "n_ps-bms-webview-lg-0.10-10k_spam" -o "./results/n_ps-bms-webview-lg-0.10-10k_results_spam.json" -n 5 --benchmarkRuntime --spam
