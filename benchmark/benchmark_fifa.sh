...
#java -jar -Xmx40G ProseccoBenchmark.jar -f "/home/ez/data/sequence/fifa.txt" -s 0.35 -z 10000 -d 2045000 -r "/usr/local/bin/shuf" -i "n_ps-fifa-lg-0.35-10k" -o "./results/n_ps-fifa-lg-0.35-10k_results_runtime_correctness.json" -n 5 --benchmarkRuntime --prosecco
